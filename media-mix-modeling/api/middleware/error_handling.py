"""
Error handling middleware for the Media Mix Modeling API.
...
class AttributionError(APIError):
    """Error in attribution analysis operations."""
    
    def __init__(self, message: str, details: Dict[str, Any] = None):
        super().__init__(message, "ATTRIBUTION_ERROR", details)

class OptimizationError(APIError):
    """Error in budget optimization operations."""
