"""
Rate limiting middleware for the Media Mix Modeling API.
...
class RateLimitingMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self):
        ...
        # Rate limit configuration for MMM operations
        self.rate_limits = {
            "/api/v1/attribution": {"max_calls": 20, "window_seconds": 60},   # 20 requests per minute
            "/api/v1/optimization": {"max_calls": 10, "window_seconds": 60},  # 10 requests per minute  
            "/api/v1/performance": {"max_calls": 50, "window_seconds": 60},   # 50 requests per minute
